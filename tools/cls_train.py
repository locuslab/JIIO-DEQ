...
from core.cls_function import train, validate, validate_proj, train_proj
...
def main():
    ...
    for epoch in range(last_epoch, config.TRAIN.END_EPOCH):
        ...
        # train for one epoch
        if config.MODEL.PROJ_GD:
            train_proj(config, train_loader, model, criterion, optimizer, lr_scheduler, epoch,
